    ...
    <div className="instructor-page">
      <div className="instructor-card">
        ...
        <div className="instructor-info">
          <h1>MD. Shahriyar Rahim</h1>
          <h4>Your Instructor</h4>
          <p>
            Hello! I'm MD. Shahriyar Rahim, a passionate MERN stack developer
          ...
          <div className="social-links">
            <a
              href="https://github.com/Shahriyar-Rahim"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/md-shahriyar-rahim/"
              target="_blank"
              rel="noopener noreferrer"
            >
              LinkedIn
            ...
            <a
              href="https://x.com/shahriyarrahim"
              target="_blank"
              rel="noopener noreferrer"
            >
              Twitter
